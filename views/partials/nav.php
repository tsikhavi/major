<header>
<nav class="sticky top-0 z-50 bg-slate-100 border-slate-200 px-4 font-sans text-sm capitalize 
                ...
                <span class="text-slate-500 dark:text-slate-200 px-1 text-xl inline">|</span>
                    <a href="#" class="text-slate-800 hover:text-green-500 dark:text-slate-200 bg-slate-200
                     dark:bg-slate-600 hover:bg-slate-200 dark:hover:bg-slate-700  focus:ring-4 dark:hover:text-green-500
                ...
                <div class=" hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="/" class="block py-2 pr-4 pl-3 text-slate-700 border-b border-slate-100
                             hover:bg-slate-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-green-500 lg:p-0
                              ...
                              lg:dark:hover:bg-transparent dark:border-slate-700" aria-current="page">Home
                            ...
                            <a href="/contact" class="block py-2 pr-4 pl-3 text-slate-700 border-b border-slate-100
                             hover:bg-slate-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-green-500 lg:p-0
                              dark:text-slate-400 lg:dark:hover:text-green-500 dark:hover:bg-slate-700
                               dark:hover:text-green-500 lg:dark:hover:bg-transparent dark:border-slate-700">contact
                            </a>
                        </li>
                        <li>
                            <a href="/services" class="block py-2 pr-4 pl-3 text-slate-700 border-b border-slate-100
                             hover:bg-slate-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-green-500 lg:p-0
                              dark:text-slate-400 lg:dark:hover:text-green-500 dark:hover:bg-slate-700
                               dark:hover:text-green-500 lg:dark:hover:bg-transparent dark:border-slate-700">services
